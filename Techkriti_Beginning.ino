...
void loop() {
  ...
  if ((ir[0] && ir[1] && ir[2]) || (ir[5] && ir[7]) || (ir[0] && ir[1] && ir[2] && ir[3] && ir[4] && ir[7]) || (!ir[0] && !ir[1] && !ir[2] && !ir[3] && !ir[4] && !ir[5] && !ir[6] && !ir[7])) {
...
void LSR() {
  if (irr[7] && irr[6] && irr[5]) {
    ...
    if (digitalRead(ir1) == 1 || digitalRead(ir2) == 1 || digitalRead(ir3) == 1 || digitalRead(ir4) == 1 || digitalRead(ir5) == 1 || digitalRead(ir6) == 1 || digitalRead(ir7) == 1 || digitalRead(ir8) == 1) {
